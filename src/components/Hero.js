    ...
    >
      ...
      <div className="section-container w-full relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            <p className="text-violet-500 dark:text-violet-400 text-sm font-medium tracking-widest uppercase mb-3">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-[Outfit] text-zinc-900 dark:text-white leading-tight mb-4 transition-colors">
              Hi, I&apos;m{" "}
              <span className="gradient-text">Md Saikot Islam</span>
            </h1>

            {/* Typing Effect */}
            <div className="h-10 mb-6 flex items-center justify-center lg:justify-start">
              <span className="text-lg sm:text-xl text-zinc-600 dark:text-zinc-300 font-medium transition-colors">
                {displayText}
              </span>
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-base leading-relaxed max-w-lg mx-auto lg:mx-0 mb-8 transition-colors">
              ...
              Passionate about learning, problem-solving, and creating impactful
              digital experiences.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                <Button
                  className="glow-btn w-full sm:w-auto font-semibold shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 px-6 py-7 text-lg"
                  radius="lg"
                  startContent={<FiDownload className="text-xl" />}
                >
                  Download Resume
                </Button>
              </a>
              <Button
                className="border-violet-500/40 text-violet-600 dark:text-violet-300 hover:bg-violet-500/10 font-semibold px-6 py-7 text-lg"
                variant="bordered"
                radius="lg"
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              {[
                ...
                <a
                  ...
                  className="w-12 h-12 rounded-xl bg-violet-500/5 dark:bg-white/5 border border-violet-500/10 dark:border-white/10 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:text-violet-500 hover:border-violet-500/40 hover:bg-violet-500/10 transition-all duration-300 text-xl"
                >
                  {social.icon}
                </a>
              ))}
          ...
          >
            <div className="relative">
              ...
              {/* Image Container */}
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-violet-500/30 animate-glow-pulse shadow-2xl shadow-violet-500/20">
                <Image
